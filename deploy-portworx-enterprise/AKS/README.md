1. Log into [Portworx Central](https://central.portworx.com/), create a login by registering if you have not already done this:
...
6. Click on the cloud radio button and select Azure from the pulldown list of values:
...
7. Click on the cloud radio button and select Azure from the pulldown list of values:
...
8. Click on the cloud radio button and select Azure from the pulldown list of values:
...
9. Click on the cloud radio button and select Azure from the pulldown list of values:
...
10. Click on the cloud radio button and select Azure from the pulldown list of values:
